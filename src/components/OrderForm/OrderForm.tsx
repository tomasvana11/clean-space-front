...
export function OrderForm({ locale }: OrderFormProps) {
  ...
  // Ref pro scroll na začátek formuláře
  ...
  // Scroll na začátek při změně kroku
  useEffect(() => {
  ...
  // Upravená funkce nextStep s scrollem
  const handleNextStep = () => {
    nextStep();
  };

  // Upravená funkce prevStep s scrollem
  ...
  return (
    <ContentWrapper className="!px-0">
      {/* Ref element pro scroll - umístěný na začátek formuláře */}
